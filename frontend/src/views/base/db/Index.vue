<template>
	<div id="app-base-db">
		...
		<div class="one-block-2">
			<a-row>
				<a-col :span="8"> • LowDB本地JSON数据库 </a-col>
				<a-col :span="8"> • 可使用lodash语法 </a-col>
				<a-col :span="8"> </a-col>
			</a-row>
		</div>
		<div class="one-block-1">
		...
		<div class="one-block-2">
			<a-row>
				...
				<a-col :span="3"> </a-col>
				<a-col :span="6">
					<a-button @click="dbOperation('add')"> 添加 </a-button>
				</a-col>
			</a-row>
		</div>
		<div class="one-block-1">
		...
		<div class="one-block-2">
			<a-row>
				...
				<a-col :span="3"> </a-col>
				<a-col :span="6">
					<a-button @click="dbOperation('get')"> 查找 </a-button>
				</a-col>
			</a-row>
			<a-row>
				<a-col :span="24">
		...
		<div class="one-block-2">
			<a-row>
				...
				<a-col :span="3"> </a-col>
				<a-col :span="6">
					<a-button @click="dbOperation('update')"> 更新 </a-button>
				</a-col>
			</a-row>
		</div>
		<div class="one-block-1">
		...
		<div class="one-block-2">
			<a-row>
				...
				<a-col :span="3"> </a-col>
				<a-col :span="6">
					<a-button @click="dbOperation('del')"> 删除 </a-button>
				</a-col>
			</a-row>
		</div>
	</div>
